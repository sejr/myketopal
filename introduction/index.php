...
<div class="intro">
  <div class="container">
    <h1>Keto in a Nutshell</h1>
    <p class="introLead">Version 3, Updated 2012-06-09</p>
  </div>
</div>
<div class="container">
  <br><br>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="intro_box">
        <h3 class="page-header">What do I eat?</h3>
        <p>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="intro_box">
        <h4 class="page-header">How do I guarantee I'm in ketosis?</h4>
        <p>
          An easy way to know for sure you are in ketosis is to use ketostix. These little sticks can be found in most pharmacies and even online. They only test for excess ketones, so they aren’t always the most reliable, but if you see a positive on the stick you are guaranteed to be in ketosis. 
        </p>
        <p>
    ...
    <div class="col-md-8">
      <div class="intro_box">
        <h3 class="page-header">What happens when my body adapts?</h3>
      <p>
...
<div class="intro">
  <div class="container">
    ...
    <p class="introLead">Once you get over the initial hump of carb cravings, they go away! Since keto will stabilize your blood sugar, it will also stabilize your hunger and cravings. Since your body is now adjusting to a low-sugar diet, you will find that your taste buds will change as well and you can now easily detect the sugar content in certain foods. Items such as carrots and dark chocolate now taste sweeter. The longer you stick to keto and the stricter you are, the less you will miss carbs. Carbs and sugar are truly addictive, and like anyone else trying to break an addiction, the best method is to cut out the source of the problem.</p>
  </div>
</div>
<?php
  include("../footer.php");
